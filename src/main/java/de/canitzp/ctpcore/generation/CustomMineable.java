 ...
 * @author canitzp
 */
public class CustomMineable extends WorldGenMinable{
    ...
    public CustomMineable(IBlockState state, int blockCount){
    ...
    public List<BlockPos> customGenerate(World world, Random rand, BlockPos pos){
        ...
        List<BlockPos> spawnedOres = new ArrayList<>();
